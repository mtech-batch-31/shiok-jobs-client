  ...
  if (event == 'signIn') {
    try {
      ...
      Auth.currentSession().then((res) => {
        Cookies.set(ACCESS_TOKEN, res.getAccessToken().getJwtToken(), {
          path: '/',
        });
        Cookies.set(REFRESH_TOKEN, res.getRefreshToken().getToken(), {
          path: '/',
        });
        Cookies.set(ID_TOKEN, res.getIdToken().getJwtToken(), { path: '/' });
