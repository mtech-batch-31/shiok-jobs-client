  ...
  return (
    <Container fluid className="bgimage vh-100">
      <Row className="d-flex justify-content-center">
        ...
        <div className="App">
        <Link to="https://shiok-jobs.auth.ap-southeast-1.amazoncognito.com/oauth2/authorize?response_type=code&client_id=54cq161otkrf4pqnods75b2lcm&redirect_uri=https://d2loqognvf0v5n.cloudfront.net/login&scope=openid+email+phone+aws.cognito.signin.user.admin&identity_provider=Google&state=9RmWtPYDDYBmw41IVDm13MHXifQoVyVK">
